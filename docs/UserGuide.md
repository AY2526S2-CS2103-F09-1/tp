...
![result for 'add n/John Doe t/Student t/Trial p/98765432 a/John street, block 123, #01-01 r/new student'](images/AddCommandResult.png)
...
* For a given contact, adding a tag that already exists has no effect; deleting a tag that does not exist has no effect.
...
| --- | --- |
| **Add** | `add n/NAME [p/PHONE_NUMBER] [a/ADDRESS] [r/REMARK] [d/WEEKLY_TIMESLOT] [l/MEETING_LINK] [t/TAG]…​` <br> e.g., `add n/James Ho`, `add n/James Ho p/89761234 a/123, Clementi Rd, 119224 r/new student d/Wed 18:00 - 19:30 l/https://zoom.us/j/123456789 t/Student t/Trial` |
