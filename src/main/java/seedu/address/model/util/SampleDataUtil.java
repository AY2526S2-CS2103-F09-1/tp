    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(Id.of(1), new Name("Alex Yeoh"), Optional.of(new Phone("87438807")),
                ...
                Optional.of(new Time("Sunday 10:00")), getTagSet("Student", "Primary"),
            ...
            new Person(Id.of(2), new Name("Bernice Yu"), Optional.of(new Phone("99272758")),
                ...
                Optional.<Time>empty(), getTagSet("Student", "Secondary"), Optional.empty(),
            ...
            new Person(Id.of(3), new Name("Charlotte Oliveiro"), Optional.of(new Phone("93210283")),
                ...
                Optional.<Time>empty(), getTagSet("Tutor", "JC"), Optional.empty(),
                Optional.empty()),
            ...
            new Person(Id.of(5), new Name("Irfan Ibrahim"), Optional.of(new Phone("92492021")),
                ...
                Optional.<Time>empty(), getTagSet("Parent", "Unpaid"), Optional.of(new Remark("new student")),
                Optional.empty()),
            new Person(Id.of(6), new Name("Roy Balakrishnan"), Optional.of(new Phone("92624417")),
                ...
                Optional.<Time>empty(), getTagSet("Student", "JC"), Optional.empty(), Optional.empty())
        };
    }
